...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('projects.update',$project) }}" method="POST" class="row" style="flex-direction:column;gap:12px">
            @csrf @method('PUT')
            ...
            <div class="row">
                ...
                <a class="btn" href="{{ route('projects.show',$project) }}">Back</a>
            </div>
        </form>
    </div>
@endsection
